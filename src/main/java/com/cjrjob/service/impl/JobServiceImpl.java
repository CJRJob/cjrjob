...
public class JobServiceImpl implements IJobService {
    ...
    public ServerResponse showJobDetails(Integer id) {
        ...
        City city = cityMapper.selectByJobFullInfoId(id);
        JobKind selectkind = jobKindMapper.selectkind(id);
        Recruiter recruiter = recruiterMapper.selectRecuByjob_full_info_id(id);
